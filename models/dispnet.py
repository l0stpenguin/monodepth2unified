...
class DispNet(nn.Module):
    ...
    def __init__(self, alpha=10, beta=0.01, num_scales=4):
    ...
    def forward(self, img, frame_id):
        ...
        out_upconv1 = crop_like(self.upconv1(out_iconv2), img)
        disp2_up = crop_like(F.interpolate(disp2, scale_factor=2, mode='bilinear', align_corners=False), img)
        ...
        for s in range(self.num_scales):
            outputs[("disp", frame_id, s)] = disps[s]
